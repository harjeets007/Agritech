        ...
        <>
            <div className="relative w-full h-screen">
                ...
                <div className="absolute right-[8%] top-1/2 -translate-y-1/2 hidden lg:block z-20">
                    <div className="bg-green-700 text-white rounded-2xl p-10 w-95 relative shadow-xl">
                        ...
                        <div className="absolute -top-16 left-10 bg-white p-2 rounded-full w-35 h-35 flex items-center justify-center shadow-md">
                            <img
